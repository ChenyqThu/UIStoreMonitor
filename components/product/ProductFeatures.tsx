...
export const ProductFeatures: React.FC<ProductFeaturesProps> = ({ tags, specs }) => {
  const [expandedSections, setExpandedSections] = React.useState<Set<string>>(new Set(['features', 'specs']));
